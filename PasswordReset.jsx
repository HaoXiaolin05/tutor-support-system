      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        ...
        >
          <div className="flex flex-col items-center gap-6 p-8">
            <p className="w-full text-xl text-center font-medium text-gray-900 tracking-[0] leading-[normal] opacity-0 translate-y-[-1rem] animate-fade-in [--animation-delay:200ms]">
